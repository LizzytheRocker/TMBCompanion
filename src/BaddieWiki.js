	...
	render() {
		return (
			<div className='BaddieWiki'>
				...
				<h5><b>Poison #:</b> Set or reset a Poison Effect Die (Looks like a bottle with a skull and crossbones) on target to #. Target takes True Dmg equal to the Effect Die # at the start of its turn. After applying Dmg,
					reduce Effect Die by 1.</h5>
				...
				<h5><b>Taunt:</b> Place Taunt Effect Die (looks like a speech bubble with symbols in it) on this unit until the start of its next turn. Adjacent opposing units must attack this unit (units with multiple targets will attack this unit
					multiple times).</h5>
				<h5><b>Terrify:</b> After this unit is attacked, place a Terrify Effect Die (looks like a screaming face) on the attacking unit until the end of its next turn. If a unit has a Terrify Effect Die on it at the start of its next turn,
					it may not target any units with Skill: Terrify.</h5>
				...
				<h5><b>Untargetable:</b> Place Untargetable Effect Die (looks like a branch with three leaves) on this unit. Until the start of this unit's next turn, it cannot be targeted by opposing units (Baddies with no target on the Battle Mat
					will not move).</h5>
